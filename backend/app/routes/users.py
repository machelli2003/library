...
@users_bp.patch("/<path:user_id>/deactivate")
@role_required("admin")
...
@users_bp.patch("/<path:user_id>/activate")
@role_required("admin")
...
@users_bp.patch("/<path:user_id>/role")
@role_required("admin")
